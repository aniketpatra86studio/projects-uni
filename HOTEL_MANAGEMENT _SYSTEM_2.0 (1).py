...
#-----------------Room Creation Logic-------------------------------------------#DHERYA MALHOTRA
...
for i in range(101, 121):
    rooms[i] = {"name": "-", "mobile": "-", "id": "-"}

# ---------------- SHOW ROOMS --------------------------------------------------#ADITYA KUMAR
def show_rooms():
    print("\nROOM DETAILS")
    print("Room\tName\tMobile\tID")
    print("----------------------------------------")
    
    for r in rooms:
        print(f"{r}\t{rooms[r]['name']}\t{rooms[r]['mobile']}\t{rooms[r]['id']}")
    
    input("\nPress Enter to continue...")

# ---------------- BOOK ROOM ---------------------------------------------------#ANIKET PATRA
def book_room():
...
def update_or_remove():
    ...
    if room in rooms and rooms[room]["name"] != "-":
        ...
        if choice == "1":
            ...
            rooms[room] = {"name": "-", "mobile": "-", "id": "-"}
            print("Customer removed (room empty now)")
